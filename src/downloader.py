...
class ModelDownloader:
    ...
    MODEL_REGISTRY = {
        "gemma-2-9b": {
            ...
            "files": ["model-00001-of-00004.safetensors", "model-00002-of-00004.safetensors", "model-00003-of-00004.safetensors", "model-00004-of-00004.safetensors", "model.safetensors.index.json", "config.json", "tokenizer.json"],
            "type": "safetensors"
...
,            "description": "Meta Llama 3.1 Instruct - 8B parameters (requires HF access)"
        ...
        "mistral-7b": {
            ...
            "files": ["model-00001-of-00003.safetensors", "model-00002-of-00003.safetensors", "model-00003-of-00003.safetensors", "model.safetensors.index.json", "config.json", "tokenizer.json", "tokenizer_config.json"],
            "type": "safetensors"
